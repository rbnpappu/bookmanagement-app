...
test('Should check Categrory works or not', () => {

  const book: any = {
    title: "Bela Kiss: Prologue"
  }
  const { container, getByText } = render(<Display booklist={booklist} cat={"horror"} />);
